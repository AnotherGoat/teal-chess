    ...
    void log(Game game) {
        ...
        */
        ...
        if (enPassantTarget != null) {
            Gdx.app.debug(LOG_TAG, "En passant target: " + board.squareAsUnicode(enPassantTarget) + enPassantTarget);
        }
        ...
        switch (game.playerStatus()) {
            case OK -> Gdx.app.log(LOG_TAG, "The game continues like normal...");
