...
final class QueenMoveGeneratorTest {
    ...
    void normalMoves() {
        ...
        var unexpectedMoves = new Move[] {
            new Move(NORMAL, d5, d3), new Move(NORMAL, d5, b3), new Move(NORMAL, d5, b7), new Move(NORMAL, d5, g5)
        };
    ...
    void captures() {
        ...
        var expectedCaptures = new Move[] {new Move(CAPTURE, d5, a5), new Move(CAPTURE, d5, g2)};
