...
final class AttackGeneratorTest {
    ...
    void kingAttacks() {
        ...
        var expectedAttacks = new Attack[] {
            new Attack(king, Coordinate.of("d1")),
            new Attack(king, Coordinate.of("f1")),
            new Attack(king, Coordinate.of("d2")),
            new Attack(king, Coordinate.of("e2")),
            new Attack(king, Coordinate.of("f2"))
        };
    ...
    void pawnAttacks() {
        ...
        var expectedAttacks =
                new Attack[] {new Attack(pawn, Coordinate.of("b4")), new Attack(pawn, Coordinate.of("d4"))};
        var kingAttacks = 5;
    ...
    void knightAttacks() {
        ...
        var expectedAttacks = new Attack[] {
            new Attack(knight, Coordinate.of("e3")),
            new Attack(knight, Coordinate.of("f2")),
            new Attack(knight, Coordinate.of("h2")),
            new Attack(knight, Coordinate.of("f6"))
        };
        var kingAttacks = 5;
    ...
    void bishopAttacks() {
        ...
        var expectedAttacks = new Attack[] {
            new Attack(bishop, Coordinate.of("a1")),
            new Attack(bishop, Coordinate.of("c3")),
            new Attack(bishop, Coordinate.of("a7")),
            new Attack(bishop, Coordinate.of("h8")),
            new Attack(bishop, Coordinate.of("g1")),
            new Attack(bishop, Coordinate.of("f2"))
        };
        var kingAttacks = 5;
    ...
    void rookAttacks() {
        ...
        var expectedAttacks = new Attack[] {
            new Attack(rook, Coordinate.of("a1")),
            new Attack(rook, Coordinate.of("a3")),
            new Attack(rook, Coordinate.of("a7")),
            new Attack(rook, Coordinate.of("a8")),
            new Attack(rook, Coordinate.of("c4")),
            new Attack(rook, Coordinate.of("d4")),
            new Attack(rook, Coordinate.of("g4")),
            new Attack(rook, Coordinate.of("h4"))
        };
        var kingAttacks = 5;
    ...
    void queenAttacks() {
        ...
        var expectedAttacks = new Attack[] {
            new Attack(queen, Coordinate.of("c8")),
            new Attack(queen, Coordinate.of("c1")),
            new Attack(queen, Coordinate.of("a7")),
            new Attack(queen, Coordinate.of("h7")),
            new Attack(queen, Coordinate.of("b8")),
            new Attack(queen, Coordinate.of("a5")),
            new Attack(queen, Coordinate.of("h2")),
            new Attack(queen, Coordinate.of("d8"))
        };
        var kingAttacks = 5;
