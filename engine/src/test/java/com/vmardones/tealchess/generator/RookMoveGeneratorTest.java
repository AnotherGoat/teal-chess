...
final class RookMoveGeneratorTest {
    ...
    void normalMoves() {
        ...
        var unexpectedMoves = new Move[] {new Move(NORMAL, d4, g4), new Move(NORMAL, d4, d7)};
    ...
    void captures() {
        ...
        var expectedCaptures = new Move[] {new Move(CAPTURE, a4, a7), new Move(CAPTURE, a4, a1)};

        var unexpectedCaptures =
                new Move[] {new Move(CAPTURE, a4, a6), new Move(CAPTURE, a4, d4), new Move(CAPTURE, a4, d5)};
    ...
    void blockedSlidingMoves() {
        ...
        var unexpectedMoves = new Move[] {
            new Move(NORMAL, f6, f8), new Move(NORMAL, f6, f2), new Move(CAPTURE, f6, h6), new Move(CAPTURE, f6, a6)
        };
